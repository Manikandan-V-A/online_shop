...
import img1 from './assets/tws.png'
...
export function TwsBoat() {
    ...
    return (
        <>
            ...
            {/* <div id="contact"> */}
            <div className="tws-main">
                <div className="row">
                    <div className="tws-left">
                        <h1>True Wireless</h1>
                        <h1><span>Earbuds </span></h1>
                        <h3>Staring from ₹1,999*</h3>
                        <button className="tws-btn">Shop Product</button>
                    </div>
                    <div className="tws-right">
                        <img className="tws-img" src={img1} alt="" />
                    </div>
                </div>
            </div>
            {/* </div> */}
